...
class Lista {
    ...
    public Game removerInicio() throws Exception {
      ...
      tmp.prox = null; //esvaziar o proximo do tmp
    ...
    public Game removerFim() throws Exception{
        ...
        Celula i;
        for(i = primeiro; i.prox != ultimo; i = i.prox); //identificar qual o penultimo elemento
        Game elemento = ultimo.elemento; //salvar pra retornar qual foi removido
        ultimo = i; //fazer o *ultimo apontar pro novo ultimo
        i = ultimo.prox = null; //esvaziar o elemento i e o *ultimo.prox 
    ...
    public void inserir(Game x, int pos) throws Exception{
        ...
        if (pos < 0 || pos > tamanho) {
            ...
            i.prox = tmp; //fazer a celula antes da inserida apontar pra inserida
    ...
    public Game remover(int pos) throws Exception{
        ...
        if (primeiro == ultimo || pos < 0 || pos >= tamanho){
            ...
            for(int j = 0; j < pos; j++, i = i.prox); //colocar o j 1 posicao antes da posicao que vai ser inserirda
                                                      //colocar o i apontando pra celula antes da posicao que vai ser inserida
            Celula tmp = i.prox; //criar uma celula apontando pra posicao que vai ser removido
            elemento = tmp.elemento; //guardar elemento que vai ser removido para retornar
            i.prox = tmp.prox; //fazer o elemento anterior ao removido apontar pro posterior
            tmp.prox = null; //esvaziar o elemento removido
            i = tmp = null; // esvaziar o elemento removido
        }
