...
class Pilha{
   ...
   /**
    * empilhar - inserir game na proxima posicao do array
    * @param {Game x}
    */ 
   ...
   /**
    * desempilhar - remover ultimo game adicionado no array
    */ 
   ...
   public void mostrar(){
    ...
    //funcao para saber o tamanho caso precisasse
    public int getSize() {
        return this.n;
    }

    //funcao para saber o game na posicao
